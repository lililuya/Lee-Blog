  ...
  return [
    {
      ...
      detail: `Since ${formatDate(footerAnalytics.launchedAt, "yyyy-MM-dd")}`,
      icon: Clock3,
    },
    {
      label: "Unique Visitors",
      value: footerAnalytics.uniqueVisitors.toLocaleString("en-US"),
      detail: "Distinct IPs recorded by the site",
      icon: Activity,
    },
    {
      label: "Total Visits",
      value: footerAnalytics.totalVisits.toLocaleString("en-US"),
      detail: "All recorded visits across the site",
      icon: RadioTower,
    },
    {
      label: "Active Regions",
      value: footerAnalytics.activeRegions.toLocaleString("en-US"),
      detail: "Regions with recent traffic based on IP data",
      icon: Globe2,
    },
  ];
}
...
function buildFooterOverviewCards(footerAnalytics: FooterAnalytics) {
  ...
  return [
    {
      label: "Top Region",
      value: topRegion?.label ?? "Waiting for data",
      detail: topRegion
        ? `${topRegion.uniqueVisitors.toLocaleString("en-US")} IPs / ${topRegion.totalVisits.toLocaleString("en-US")} visits`
        : "Shown automatically after fresh traffic arrives",
    },
    {
      label: "Latest Activity",
      value: latestRegion?.label ?? "No record yet",
      detail: latestRegion
        ? `${formatDate(latestRegion.lastSeenAt, "MM-dd")} latest visit recorded`
        : "Waiting for the next visit event",
    },
    {
      label: "Visits per Visitor",
      value: `${averageVisitsPerVisitor} visits`,
      detail: "Average visits generated by each unique visitor",
    },
  ];
}
        ...
        <div className="space-y-5">
          <div className="max-w-3xl space-y-3">
            ...
            <p className="text-sm leading-7 text-[var(--ink-soft)]">
              A compact readout of uptime, traffic volume, and the regions that have been active
              most recently.
            </p>
          </div>
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[var(--ink-soft)]">
                        Traffic Hotspot {String(index + 1).padStart(2, "0")}
                      </p>
