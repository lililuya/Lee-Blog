...
export const demoPosts = [
  ...
  },
  {
    ...
    excerpt:
      "一篇面向维护者与读者的中文说明文档，系统梳理这个博客的定位、技术架构、前后台功能、研究工作流、AI 工具与后续可扩展方向。",
    content: `## 这不是一个普通的静态博客\n\n这个项目已经把公开写作、后台管理、研究工作流、评论互动、AI 工具和运维能力整合到了一起，更接近一套个人内容操作系统。\n\n## 当前最重要的结构\n\n- 前台公开内容发布与发现\n- 管理员后台与审核能力\n- 论文、周报与研究工作流\n- API 调试、聊天与 RAG 工具链\n\n## 为什么把这篇文章放到置顶\n\n因为它比单篇文章更能代表这个站点现在真正是什么，以及之后准备往哪里继续扩展。`,
    category: "站点文档",
    language: "zh-CN",
    tags: ["博客系统", "架构设计", "功能文档", "Next.js", "Prisma"],
    status: "PUBLISHED",
    pinned: true,
    featured: true,
    coverImageUrl: "",
    readTimeMinutes: 8,
    translationOfId: null,
    publishedAt: new Date("2026-03-23T04:30:00.000Z"),
    createdAt: new Date("2026-03-23T04:30:00.000Z"),
    updatedAt: new Date("2026-03-23T04:30:00.000Z"),
    authorId: "demo-admin",
    author: {
      id: "demo-admin",
      name: "Mark Lee",
  ...
  },
  {
    ...
    createdAt: new Date("2026-03-12T07:45:00.000Z"),
    updatedAt: new Date("2026-03-12T07:45:00.000Z"),
    authorId: "demo-admin",
    author: {
      id: "demo-admin",
      name: "Mark Lee",
...
export const demoComments = [
  ...
  },
  {
    id: "demo-comment-2",
    content:
      "Exactly. When a workflow exposes the intermediate steps, readers can question the system earlier instead of only judging the final output.",
    status: "APPROVED",
    moderationNotes: null,
    moderationMatches: [],
    createdAt: new Date("2026-03-09T10:10:00.000Z"),
    updatedAt: new Date("2026-03-09T10:10:00.000Z"),
    postId: "demo-post-1",
    authorId: "demo-admin",
